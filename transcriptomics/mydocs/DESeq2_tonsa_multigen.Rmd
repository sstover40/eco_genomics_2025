...
changed the gene name = " " from the table above 
```{r}
...
p <- p + geom_point(position=position_jitter(w=0.2,h=0), size=3) +
  scale_fill_manual(values=c("#CC3333",'#6699CC'))
...
##Let’s make a Euler plot of shared differentially expressed genes between CvsT across generations Identify the DEGs in the contrast for control versus treatment for each generation
