...
#This script will use ANGSD to estimate Fst btwn red spruce pop and black spruce from outside the range 

#Path to pop genomics folder in the repo
REPO="/users/s/s/sstover/projects/eco_genomics_2025/population_genomics"

#Path to black spruce (BS) input saf.idx data 
BLKSPR="/gpfs1/cl/ecogen/pbio6800/PopulationGenomics/ANGSD/black_spruce"

#make directory in 'myresults/ANGSD' to store results 
